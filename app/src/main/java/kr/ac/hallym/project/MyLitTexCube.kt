...
class MyLitTexCube(myContext: Context) {
    ...
    init {
        val vertexShader: Int =
            loadShader(GLES30.GL_VERTEX_SHADER, "cube_tex_vert.glsl", myContext)
        val fragmentShader: Int =
            loadShader(GLES30.GL_FRAGMENT_SHADER, "cube_tex_frag.glsl", myContext)
        ...
        GLUtils.texImage2D(GLES30.GL_TEXTURE_2D, 0, loadBitmap("soccerball.bmp", myContext), 0)
